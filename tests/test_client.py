...
class GitHubClientTests(unittest.TestCase):
    ...
    def test_retries_on_429_rate_limit(self) -> None:
        """Test that transient error 429 triggers a retry."""
    ...
    def test_query_exceeds_256_chars(self) -> None:
        """Test that query exceeding 256 characters raises ValueError."""
        client = GitHubClient()
        long_query = "a" * 257
        with self.assertRaisesRegex(ValueError, "256 character limit"):
            client.search_issues(long_query)
